...
export const Box = styled('div', { shouldForwardProp })(compose(...boxParamsArray))
...
export const SvgIcon = ({ flipXIfRTL, children, ...props }) => (
    <Span
        display="inline-block"
        transform={`translateY(-1px) ${
            flipXIfRTL && theme.direction === 'rtl' ? 'scaleX(-1)' : ''
        }`}
        {...props}
    >
        {children}
